...
<div class="container mt-5">
    ...
    <form action="/admin/pets/update" method="post" class="row g-3">
        ...
        <div class="col-md-2">
            ...
            <input type="number" name="age" class="form-control" value="${pet.age}" required min="0">
        </div>
        ...
        <div class="col-md-6">
            ...
            <select name="clinic.clinicId" class="form-select" required>
                <c:forEach var="clinic" items="${clinics}">
                    <option value="${clinic.clinicId}" <c:if test="${clinic.clinicId == pet.clinic.clinicId}">selected</c:if>>
                            ${clinic.clinicName}
                    </option>
                </c:forEach>
            </select>
