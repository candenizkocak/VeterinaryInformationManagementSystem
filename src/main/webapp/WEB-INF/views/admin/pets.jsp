...
<div class="container mt-5">
    ...
    <form action="/admin/pets/create" method="post" class="row g-3 mb-4">
        ...
        <div class="col-md-2"><label class="form-label">Age</label><input type="number" name="age" class="form-control" min="0" required></div>
        <div class="col-md-3">
        ...
        <c:forEach var="pet" items="${pets}">
            <tr>
                ...
                <td>
                    ...
                    <a href="/admin/medical-records/pet/${pet.petID}" class="btn btn-info btn-sm mt-1">Medical Records</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
